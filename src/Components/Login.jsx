...
const Login = () => {
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-emerald-100 w-full">
      {/* User Login */}
      <Link
        to="/user-login"
      ...
      >
        <div className="bg-gradient-to-l from-emerald-100 to-emerald-900 flex flex-col gap-6 items-center justify-center min-h-screen p-12 lg:p-32 text-white group-hover:bg-white group-hover:text-emerald-900 transition-all duration-500 ease-in-out">
      ...
      >
        <div className="bg-gradient-to-r from-emerald-100  to-emerald-900 flex flex-col gap-6 items-center justify-center min-h-screen p-12 lg:p-32 text-white group-hover:bg-white group-hover:text-emerald-900 transition-all duration-500 ease-in-out">
